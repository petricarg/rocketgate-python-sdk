...
class RebillStatusTest(BaseTestCase):
    ...
    def test(self):
        ...
        self.assertTrue(self.service.PerformRebillUpdate(request, self.response), "Check rebill status")

        self.assertIsNone(self.response.Get(GatewayResponse.REBILL_END_DATE), "Active user and rebill set")

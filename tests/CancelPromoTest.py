...
class CancelPromoTest(BaseTestCase):
    ...
    def test(self):
        ...
        self.request.Set(GatewayRequest.REBILL_AMOUNT, "25.95")
        self.request.Set(GatewayRequest.REBILL_FREQUENCY, "QUARTERLY")

        self.assertTrue(
            self.service.PerformRebillUpdate(self.request, self.response),
